    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav class="hidden lg:flex items-center space-x-6">
                <a href="<?php echo home_url(); ?>" class="text-foreground hover:bg-foreground hover:text-background font-semibold transition-all duration-300 bg-transparent text-base px-5 py-3 rounded-md">Home</a>
                
                <div class="relative group">
                    <button class="text-foreground hover:bg-foreground hover:text-background font-semibold transition-all duration-300 bg-transparent text-base px-5 py-3 rounded-md flex items-center gap-2">
                        Services
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                    <div class="absolute top-full left-0 w-[280px] bg-background border border-border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                        <div class="p-4">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-full left-0 w-[200px] bg-background border border-border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                        <div class="p-4">
                            <div class="grid gap-1">
                ...
                <a href="/faqs" class="text-foreground hover:bg-foreground hover:text-background font-semibold transition-all duration-300 bg-transparent text-base px-5 py-3 rounded-md">FAQs</a>
            </nav>
            ...
            <div class="hidden lg:flex items-center space-x-6">
                ...
                <a href="https://book.sncleaningservices.co.uk" target="_blank" rel="noopener noreferrer" class="bg-gradient-to-r from-primary to-primary-light text-primary-foreground px-7 py-3 rounded-xl font-bold text-lg hover:shadow-lg hover:-translate-y-1 hover:scale-105 transition-all duration-300">Get Free Quote</a>
            </div>
